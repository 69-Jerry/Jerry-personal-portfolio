...
export default function Navigation({ activeSection, setActiveSection }: NavigationProps) {
  ...
  return (
    <nav className="fixed left-0 top-0 h-screen w-48 bg-primary p-8 hidden lg:flex flex-col justify-between z-50">
      <div>
        <Link href="/" className="text-2xl font-bold text-primary-foreground mb-12 block">
          {'<Jerry />'}
        </Link>
      ...
      <div className="flex gap-4 text-primary-foreground/60">
        <a href="https://github.com/69-Jerry" target="_blank" rel="noopener noreferrer" className="hover:text-primary-foreground transition-colors">
        ...
        <a href="https://www.linkedin.com/in/jerrywilsonbuakah/" target="_blank" rel="noopener noreferrer" className="hover:text-primary-foreground transition-colors">
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <a href="https://twitter.com/pressplaycfc" target="_blank" rel="noopener noreferrer" className="hover:text-primary-foreground transition-colors">
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
